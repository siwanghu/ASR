...
public class ThreadClient extends Thread implements Runnable {
    ...
    private byte[] data=new byte[1024*20*1];
...
//            }
//            if(ip==3)
//                client = new Socket("47.100.62.57", 7766);
//            else if(ip==2)
//                client = new Socket("47.100.241.183", 7766);
//            else if(ip==1)
                client =new Socket("127.0.0.1", 7766);
            ...
            long sequence = 0;
            FileInputStream in = new FileInputStream(new File("C:\\Users\\ylchen\\Desktop\\test.pcm"));
